...
vc_map(array(
	...
	'params'			=> array(
		...
		array(
            'type' 			=> 'textfield',
            'heading' 		=> __('API Key (required)', 'themelovin'),
            'param_name' 	=> 'api_key',
            'description'	=> sprintf( __('Enter your %sGoogle Maps API key%s.', 'themelovin'), '<a href="https://developers.google.com/maps/documentation/javascript/get-api-key">', '</a>')
        ),
		array(
            'type' => 'css_editor',
